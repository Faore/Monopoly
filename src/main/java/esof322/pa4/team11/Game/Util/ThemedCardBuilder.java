...
public class ThemedCardBuilder {
    public static void buildChanceCard(ObservableList<Card> chanceCards){
        ...
        chanceCards.add(new Card( 5, "Advance token to nearest payload and pay the owner twice the rent\n"  +
                " they are otherwise entitled. If payload unowned, you may buy it\n" + "from the bank"));
        chanceCards.add(new Card( 6, "Advance token to nearest payload and pay the owner twice the rent\n"  +
                " they are otherwise entitled. If payload unowned, you may buy it\n" + "from the bank"));
        ...
        chanceCards.add(new Card( 9, "Make general repairs on all your property. For each house pay $25, \n" +
                "for each hotel $100"));
        chanceCards.add(new Card( 10, "Advance to Durado Payload, if you pass go collect $200"));
        chanceCards.add(new Card( 11, "Advance to Anubis Pottery"));
        chanceCards.add(new Card( 12, "Advance to St. Underworld, if you pass go collect $200"));
        chanceCards.add(new Card( 13, "Take a flight, advance token to Lunar Colony"));
    ...
    public static void buildChestCard(ObservableList<Card> chestCards){
        ...
        chestCards.add(new Card( 14, "You have won second prize in a match. Collect $10"));
